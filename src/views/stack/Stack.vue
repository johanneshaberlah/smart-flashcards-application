    ...
    <div>
      ...
      <div class="mt-2 md:flex md:items-center md:justify-between">
        ...
        <div class="mt-4 flex flex-shrink-0 md:ml-4 md:mt-0">
          ...
          <button @click="router.push({ path: `/stack/${route.params.stackId}/magic` })" type="button" class="ml-3 inline-flex items-center rounded-md bg-yellow-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">Automatisch erstellen</button>
        </div>
      </div>
    </div>
    <div class="mt-16">
